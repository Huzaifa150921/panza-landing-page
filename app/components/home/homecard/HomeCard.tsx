...
const CardHome = ({ borderColor, Icon, textColor, iconColor, bgColor, text }: cardtopborderwithiconProps) => {
    return (
        <>
            <div className={`flex flex-col items-center justify-center gap-5 w-full sm:w-1/2 lg:w-1/4 min-h-[40vh] ${bgColor} border-solid border-t-8 ${borderColor} ${textColor}`}>
