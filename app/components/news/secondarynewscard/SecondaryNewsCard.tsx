...
const SecondaryNewsCard = ({ isEven, Icon, text, heading }: secondarynewscardProps) => {
    return (
        <div className={`w-full sm:w-1/2 lg:w-3/12 min-h-[40vh] ${isEven ? 'bg-newscard-cardbgEven border-newscard-borderEven' : 'bg-newscard-cardbgOdd border-newscard-borderOdd'} border-t-8 flex flex-col justify-center items-center p-4`}>
